...
Install the exact peer versions listed by `npm info @vue-tui/vite peerDependencies`. The plugin relies on version-specific compiler and module-runner APIs; the [starter template](../../templates/vite) ships a matching set.
