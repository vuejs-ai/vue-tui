...
const trackedFixture = fileURLToPath(new URL("./fixtures/input-hmr", import.meta.url));
const root = fileURLToPath(new URL("./tmp/input-hmr", import.meta.url));
const cacheDir = fileURLToPath(new URL("../node_modules/.vite-input-hmr-test", import.meta.url));

const appVue = `${root}/src/app.vue`;
const mainTs = `${root}/src/main.ts`;
const origAppVue = readFileSync(`${trackedFixture}/src/app.vue`, "utf8");
const origMainTs = readFileSync(`${trackedFixture}/src/main.ts`, "utf8");
