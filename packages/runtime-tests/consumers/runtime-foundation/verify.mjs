...
const consumers = {
  "coding-agent": {
    ...
    patchSha256: "640bc7c480bc056daa4368158b0520f9467cfc78d00120b0871835769baaf107",
    changedPaths: [
  ...
  mo: {
    ...
    patch: "mo.patch",
    patchSha256: "c3ad6c31f12de6499d022e199fe7d743378f0e3203ce3ac2abd4b74054ca5d11",
  ...
  machud: {
    ...
    changedPaths: [
      ...
      "src/components/BigNumber.vue",
      "src/components/Graph.vue",
      "src/components/NarrowView.vue",
      "src/components/Panel.vue",
      "src/components/Sparkline.vue",
      "src/components/panels/HeaderBar.vue",
      "src/lib/color.ts",
      "src/main.ts",
      "src/theme.ts",
    ],
