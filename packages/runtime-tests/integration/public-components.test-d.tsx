...
const boxBorderEdgeColor = <Box borderTopColor="green" borderLeftBackgroundColor="blue" />;
const boxBorderEdgeDim = <Box borderDimColor borderBottomDimColor={false} />;
...
void textWheel;
void boxBorderFrame;
void boxBorderEdgeColor;
void boxBorderEdgeDim;
