...
// Preserved: SGR sequences (colors, bold, etc. - end with 'm') and OSC
// sequences (hyperlinks, etc. - ESC ] or C1 OSC). Reducing SGR to the host's
// resolved color capability belongs to the frame encoder, which reads the
// structured color of every cell.
