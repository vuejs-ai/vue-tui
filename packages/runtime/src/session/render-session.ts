import { readonly, shallowReactive, type DeepReadonly } from "vue";
import {
...
type MutableLiveRenderSession = {
  dimensions: ResolvedLiveDimensions;
};
...
function frozenDimensions(dimensions: ResolvedLiveDimensions): ResolvedLiveDimensions {
