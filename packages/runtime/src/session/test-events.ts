...
/**
 * Events the runtime itself reports. Use these shared constants for every
 * producer and waiter: independent string literals can diverge without a type
 * error, leaving a child-program waiter to time out.
 */
