...
- Runtime behavior is proved by end-to-end and integration tests; unit tests are supplementary. Never change internal code, or add code to it, for the sake of a unit test. Vouched in [Architecture decisions](.agents/docs/architecture-decisions.md#runtime-behavior-is-proved-by-end-to-end-and-integration-tests).
