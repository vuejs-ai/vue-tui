...
- **Source:** Yunfei, 2026-07-24, acceptance of the complete [`useBoxMetrics` review](./runtime-public-api-review.md#useboxmetrics) after pinned-peer comparison and bounded adversarial capability review, followed by explicit rejection of the redundant imperative API; no durable session URL is available, so the linked review is the pinned artifact.
