...
| Outside a render tree                                                   | `useElementGeometry()` reports `unavailable`; terminal-bound composables, including the Fullscreen mouse hooks, retain their fail-fast context requirement. |
