...
The [public API contract](./api-contract.md), current re-audit, and decision ledger record the completed minimum public foundation and its current evidence. Historical implementation checkpoints do not override that boundary.
...
- requested/effective/capability behavior across inline, full-screen, non-TTY, string render, testing and HMR;
