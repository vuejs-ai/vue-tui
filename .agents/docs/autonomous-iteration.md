...
7. **Active:** cover automatic input demand, template/TSX types, both modes, non-TTY and string hosts where callable, teardown, HMR, package consumption, restoration, and the remaining `useInput`, `usePaste`, and raw-mode dispositions;
