...
8. **Active:** with HMR covered, exercise non-TTY, string and custom hosts where callable, template/TSX types, package consumption, restoration, and the remaining `useInput`, `usePaste`, and raw-mode dispositions;
