...
6. **Blocked on a maintainer decision:** remove the physical `stdin` field, replace it with a brokered route, or retain it as an explicitly unsafe raw escape hatch outside the non-duplication guarantee;
