...
| G05 | box-layout-border               | Borders skipped when content area is 1 cell tall or wide (w<2 / h<2 guard)                                                                                                          | P2       | pr-open | `fix/parity-border-1cell`          | #37 |
...
| G15 | box-layout-border               | Vertical border sides not shifted up when borderTop=false (Ink offsetY) — left/right rails mispositioned                                                                            | P2       | pr-open | `fix/parity-border-1cell`          | #37 |
