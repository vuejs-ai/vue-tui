...
| G22 | app-exit-instances-animation-sr | SR role dedup inherits grandparent role; Ink dedups only vs immediate parent                                                                                                        | P3       | pr-open   | `fix/parity-sr-role-dedup`         | #51 |
