...
| G02 | app-exit-instances-animation-sr | useAnimation does not coalesce ticks within the render-throttle window — delta does not 'account for throttled renders' | P1       | pr-open | `fix/parity-useanimation-throttle` | #35 |
