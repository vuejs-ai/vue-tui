...
| G21 | text-wrap-transform             | Nested <Transform> in <Text> gets hardcoded index 0 vs child sibling position (squash path)                                                                                         | P3       | pr-open   | `fix/parity-transform-index`       | #50 |
