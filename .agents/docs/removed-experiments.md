...
Current authority is the [Runtime public API decision ledger](./runtime-public-api-decisions.md) for what was accepted, the [public API contract](./api-contract.md) for the exact surface, and the [foundation re-audit](./runtime-public-foundation-reaudit.md) for implementation paths and evidence.
