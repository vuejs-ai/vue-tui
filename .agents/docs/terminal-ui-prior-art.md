...
> **Status:** unstamped evidence ledger, last reverified 2026-07-13. This record compares how other terminal UI systems handle rendering mode, history ownership, runtime facts, input ownership, mouse tracking, targeted events, and public widget APIs. It supplies evidence and constraints; vue-tui product and API decisions remain in [goal.md](./goal.md), [product-scenarios.md](./product-scenarios.md), [api-design.md](./api-design.md), and [render-session.md](./render-session.md).
