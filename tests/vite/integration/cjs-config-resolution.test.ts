...
//
// The fixture (tests/vite/integration/fixtures/cjs-config) has its own `type: commonjs` package.json to force the
...
const pkgRoot = dirname(require.resolve("@vue-tui/vite/package.json"));
