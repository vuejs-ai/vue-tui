/**
 * Type-only integration fixture — not a runnable program. Nothing spawns it,
...
// @ts-expect-error Transform is not a public Runtime export; the private mechanism it named was deleted.
...
export const rejected = [
  ...
  // @ts-expect-error an unknown frame name is still rejected
  <Box borderStyle="hexagon">x</Box>,
